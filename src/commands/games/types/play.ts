...
import {
	booleanOddEven,
	playerOddEvenTossEmbed,
	numberTossCheck,
	numberTossTotal,
	botBatBallToss,
	startBotBatGameEmbed,
	stringToNumber,
	botPlayerBatGameEmbed,
	botGameWicketsOverEmbed,
	numberTossEmbed,
	batBallTossEmbed,
	botPlayerBallGameEmbed,
	cannotHaveMultipleGenjutsuEmbed,
	botGameOverEmbed,
} from './!game-structure'
		...
		function playerBat(int: MessageComponentInteraction) {
			if (gamePlayerScore === gameBotScore) {
				...
				if (wicketsLeft <= 0) {
					...
					didPlayerBat = true
					return botGameWicketsOverEmbed(
						int,
						gameTotalPlayerScore,
						gameTotalBotScore,
						totalWickets,
